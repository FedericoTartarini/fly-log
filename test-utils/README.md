...
// Then render components that rely on i18n; they will use the Italain resource above
```
...
- Add an example test file demonstrating an Italian override.
- Add a short entry in the project README linking to this note.
